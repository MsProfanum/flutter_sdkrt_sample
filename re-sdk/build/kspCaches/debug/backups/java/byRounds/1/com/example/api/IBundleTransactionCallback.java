...
public interface IBundleTransactionCallback extends android.os.IInterface
{
  /** Default implementation for IBundleTransactionCallback. */
  public static class Default implements com.example.api.IBundleTransactionCallback
  {
  ...
  public static abstract class Stub extends android.os.Binder implements com.example.api.IBundleTransactionCallback
  {
    ...
    /**
     * Cast an IBinder object into an com.example.api.IBundleTransactionCallback interface,
     * generating a proxy if needed.
     */
    public static com.example.api.IBundleTransactionCallback asInterface(android.os.IBinder obj)
    {
      if ((obj==null)) {
        return null;
      }
      android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
      if (((iin!=null)&&(iin instanceof com.example.api.IBundleTransactionCallback))) {
        return ((com.example.api.IBundleTransactionCallback)iin);
      }
      return new com.example.api.IBundleTransactionCallback.Stub.Proxy(obj);
    }
    ...
    private static class Proxy implements com.example.api.IBundleTransactionCallback
    {
    ...
    static final int TRANSACTION_onSuccess = (android.os.IBinder.FIRST_CALL_TRANSACTION + 11231020);
  }
  /** @hide */
  public static final java.lang.String DESCRIPTOR = "com.example.api.IBundleTransactionCallback";
