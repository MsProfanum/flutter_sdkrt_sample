...
public interface ISdkSandboxedUiAdapterTransactionCallback extends android.os.IInterface
{
  /** Default implementation for ISdkSandboxedUiAdapterTransactionCallback. */
  public static class Default implements com.example.api.ISdkSandboxedUiAdapterTransactionCallback
  {
    ...
    @Override public void onSuccess(com.example.api.ISdkSandboxedUiAdapterCoreLibInfoAndBinderWrapper result) throws android.os.RemoteException
    {
    }
    @Override
  ...
  public static abstract class Stub extends android.os.Binder implements com.example.api.ISdkSandboxedUiAdapterTransactionCallback
  {
    ...
    /**
     * Cast an IBinder object into an com.example.api.ISdkSandboxedUiAdapterTransactionCallback interface,
     * generating a proxy if needed.
     */
    public static com.example.api.ISdkSandboxedUiAdapterTransactionCallback asInterface(android.os.IBinder obj)
    {
      if ((obj==null)) {
        return null;
      }
      android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
      if (((iin!=null)&&(iin instanceof com.example.api.ISdkSandboxedUiAdapterTransactionCallback))) {
        return ((com.example.api.ISdkSandboxedUiAdapterTransactionCallback)iin);
      }
      return new com.example.api.ISdkSandboxedUiAdapterTransactionCallback.Stub.Proxy(obj);
    }
    ...
    @Override public boolean onTransact(int code, android.os.Parcel data, android.os.Parcel reply, int flags) throws android.os.RemoteException
    {
      ...
      switch (code)
      {
        ...
        {
          com.example.api.ISdkSandboxedUiAdapterCoreLibInfoAndBinderWrapper _arg0;
          _arg0 = _Parcel.readTypedObject(data, com.example.api.ISdkSandboxedUiAdapterCoreLibInfoAndBinderWrapper.CREATOR);
    ...
    private static class Proxy implements com.example.api.ISdkSandboxedUiAdapterTransactionCallback
    {
    ...
    static final int TRANSACTION_onSuccess = (android.os.IBinder.FIRST_CALL_TRANSACTION + 259671);
  }
  /** @hide */
  public static final java.lang.String DESCRIPTOR = "com.example.api.ISdkSandboxedUiAdapterTransactionCallback";
  ...
  public void onSuccess(com.example.api.ISdkSandboxedUiAdapterCoreLibInfoAndBinderWrapper result) throws android.os.RemoteException;
  /** @hide */
