...
public class ParcelableSdkBannerRequest implements android.os.Parcelable
{
  public android.os.Bundle activityLauncher;
  public java.lang.String appPackageName;
  public boolean isWebViewBannerAd = false;
  public static final android.os.Parcelable.Creator<ParcelableSdkBannerRequest> CREATOR = new android.os.Parcelable.Creator<ParcelableSdkBannerRequest>() {
    @Override
    public ParcelableSdkBannerRequest createFromParcel(android.os.Parcel _aidl_source) {
      ParcelableSdkBannerRequest _aidl_out = new ParcelableSdkBannerRequest();
      _aidl_out.readFromParcel(_aidl_source);
      return _aidl_out;
    }
    @Override
    public ParcelableSdkBannerRequest[] newArray(int _aidl_size) {
      return new ParcelableSdkBannerRequest[_aidl_size];
    }
  };
  @Override public final void writeToParcel(android.os.Parcel _aidl_parcel, int _aidl_flag)
  {
    ...
    _Parcel.writeTypedObject(_aidl_parcel, activityLauncher, _aidl_flag);
    _aidl_parcel.writeString(appPackageName);
    _aidl_parcel.writeInt(((isWebViewBannerAd)?(1):(0)));
  ...
  public final void readFromParcel(android.os.Parcel _aidl_parcel)
  {
    ...
    try {
      ...
      activityLauncher = _Parcel.readTypedObject(_aidl_parcel, android.os.Bundle.CREATOR);
      if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) return;
      appPackageName = _aidl_parcel.readString();
      if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) return;
      isWebViewBannerAd = (0!=_aidl_parcel.readInt());
    } finally {
  ...
  public int describeContents() {
    int _mask = 0;
    _mask |= describeContents(activityLauncher);
    return _mask;
  }
