...
public interface IFullscreenAdTransactionCallback extends android.os.IInterface
{
  /** Default implementation for IFullscreenAdTransactionCallback. */
  public static class Default implements com.example.api.IFullscreenAdTransactionCallback
  {
    ...
    @Override public void onSuccess(com.example.api.IFullscreenAd result) throws android.os.RemoteException
    {
    }
    @Override
  ...
  public static abstract class Stub extends android.os.Binder implements com.example.api.IFullscreenAdTransactionCallback
  {
    ...
    /**
     * Cast an IBinder object into an com.example.api.IFullscreenAdTransactionCallback interface,
     * generating a proxy if needed.
     */
    public static com.example.api.IFullscreenAdTransactionCallback asInterface(android.os.IBinder obj)
    {
      if ((obj==null)) {
        return null;
      }
      android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
      if (((iin!=null)&&(iin instanceof com.example.api.IFullscreenAdTransactionCallback))) {
        return ((com.example.api.IFullscreenAdTransactionCallback)iin);
      }
      return new com.example.api.IFullscreenAdTransactionCallback.Stub.Proxy(obj);
    }
    ...
    @Override public boolean onTransact(int code, android.os.Parcel data, android.os.Parcel reply, int flags) throws android.os.RemoteException
    {
      ...
      switch (code)
      {
        ...
        {
          com.example.api.IFullscreenAd _arg0;
          _arg0 = com.example.api.IFullscreenAd.Stub.asInterface(data.readStrongBinder());
    ...
    private static class Proxy implements com.example.api.IFullscreenAdTransactionCallback
    {
    ...
    static final int TRANSACTION_onSuccess = (android.os.IBinder.FIRST_CALL_TRANSACTION + 11321849);
  }
  /** @hide */
  public static final java.lang.String DESCRIPTOR = "com.example.api.IFullscreenAdTransactionCallback";
  ...
  public void onSuccess(com.example.api.IFullscreenAd result) throws android.os.RemoteException;
  /** @hide */
