...
public interface IStringTransactionCallback extends android.os.IInterface
{
  /** Default implementation for IStringTransactionCallback. */
  public static class Default implements com.example.api.IStringTransactionCallback
  {
  ...
  public static abstract class Stub extends android.os.Binder implements com.example.api.IStringTransactionCallback
  {
    ...
    /**
     * Cast an IBinder object into an com.example.api.IStringTransactionCallback interface,
     * generating a proxy if needed.
     */
    public static com.example.api.IStringTransactionCallback asInterface(android.os.IBinder obj)
    {
      if ((obj==null)) {
        return null;
      }
      android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
      if (((iin!=null)&&(iin instanceof com.example.api.IStringTransactionCallback))) {
        return ((com.example.api.IStringTransactionCallback)iin);
      }
      return new com.example.api.IStringTransactionCallback.Stub.Proxy(obj);
    }
    ...
    private static class Proxy implements com.example.api.IStringTransactionCallback
    {
    ...
    static final int TRANSACTION_onSuccess = (android.os.IBinder.FIRST_CALL_TRANSACTION + 3868755);
  }
  /** @hide */
  public static final java.lang.String DESCRIPTOR = "com.example.api.IStringTransactionCallback";
